...
//		System.out.println("Grupo5:\n " + grupo5.toString());
		System.out.println("Grupo1:\n " +ordenarPorEdad(grupo1));
		System.out.println("Grupo2:\n " +ordenarPorEdad(grupo2));
		System.out.println("Grupo3:\n " +ordenarPorEdad(grupo3));
		System.out.println("Grupo4:\n " +ordenarPorEdad(grupo4));
		System.out.println("Grupo5:\n " +ordenarPorEdad(grupo5));
	...
	public static int generarRandom() {
	 ...
	 public static HashMap<String, Integer> ordenarPorEdad(HashMap<String, Integer> grupo) {
